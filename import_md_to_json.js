...
const markdownFolderPath = './public/markdown'; // Change this to your actual markdown folder path
const jsonOutputFolderPath = './public/json'; // Change this to your desired json output folder path
